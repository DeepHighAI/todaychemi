...
| 콘텐츠 | 모델 | 토큰 | 호출 빈도 | 위계 |
|---|---|---|---|---|
| 합보기 6모드 (§3.2) | **GPT-5o** | in 3,500 + out 800 | 1회/요청 | **핵심** |
| 마이플레이 (§3.4) | GPT-5o | in 2,500 + out 600 | 1회/시리즈 | 보조 |
| 친구합 (Pair Quiz) Pair Quiz | GPT-5o | in 4,000 + out 1,000 | 1회/Pair | 보조 |
...
- **GPT-5o (핵심)**: 한국어 명리 톤 + 6모드 정확성 + 품질·비용·속도 균형
...
| 합보기 | 5,000 | GPT-5o | ~$50-80 |
| 마이플레이 | 1,000 | GPT-5o | ~$10-15 |
...
- `prompt_versions` 테이블에 `model_name` 필드 추가 (`gpt-5`, `gpt-5o`, `gpt-5-mini`)
