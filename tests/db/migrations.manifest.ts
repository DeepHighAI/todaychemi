...
export const MIGRATIONS_MANIFEST: MigrationSpec[] = [
  ...
  // 앱인토스 deviceId 보조 매핑 + 기기 캠페인 부적 지급
  {
    index: 20260702000000,
    file: '20260702000000_toss_device_grants.sql',
    kind: 'table',
    tableName: 'toss_device_connections',
    columns: ['id', 'user_id', 'device_id_hash', 'first_seen_at', 'last_seen_at'],
    checkEnums: [],
    foreignKeys: [{ col: 'user_id', refs: 'auth.users' }],
    rls: { enabled: true, policies: [] },
  },
  {
    index: 20260702000001,
    file: '20260702000000_toss_device_grants.sql',
    kind: 'table',
    tableName: 'device_campaign_talisman_grants',
    columns: [
      'grant_id',
      'campaign_key',
      'user_id',
  ...
  {
    index: 20260702000002,
    file: '20260702000000_toss_device_grants.sql',
    kind: 'function',
    functionName: 'award_device_campaign_talisman',
  },
  // userId 기반 로컬 운영 부적 지급
  {
    index: 20260702010000,
    file: '20260702010000_user_campaign_talisman_grants.sql',
    kind: 'table',
    tableName: 'user_campaign_talisman_grants',
    columns: [
      'grant_id',
      'campaign_key',
      'user_id',
  ...
  {
    index: 20260702010001,
    file: '20260702010000_user_campaign_talisman_grants.sql',
    kind: 'function',
    functionName: 'award_user_campaign_talisman',
  },
];
