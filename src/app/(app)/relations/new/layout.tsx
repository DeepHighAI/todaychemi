...
const STEPS = ['/relations/new/name', '/relations/new/dob-time', '/relations/new/mode'];

export default function RelationsNewLayout({ children }: { children: React.ReactNode }) {
    ...
    <main className="bg-background min-h-screen pb-32">
      <header className="px-4 pt-3 pb-4 space-y-3">
        ...
        <div className="h-1 bg-surface-2 rounded-full">
          <div
            className="h-full bg-[var(--p-40)] rounded-full transition-[width] duration-300"
