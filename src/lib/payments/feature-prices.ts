...
export const OPENING_DISCOUNT_PERCENT = 50;
export const OPENING_DISCOUNT_LABEL = '오픈초기 50% 할인';

function openingDiscountAmount(listAmountKrw: number): number {
  return Math.round(listAmountKrw * (100 - OPENING_DISCOUNT_PERCENT) / 100);
}
...
export const FEATURE_PRICES_KRW = {
  hapcard: {
    ...
    amount_krw: openingDiscountAmount(1000),
  ...
  whatif: {
    feature_id: 'whatif',
    list_amount_krw: 800,
    amount_krw: openingDiscountAmount(800),
    discount_label: OPENING_DISCOUNT_LABEL,
  ...
  replay: {
    feature_id: 'replay',
    list_amount_krw: 600,
    amount_krw: openingDiscountAmount(600),
    discount_label: OPENING_DISCOUNT_LABEL,
