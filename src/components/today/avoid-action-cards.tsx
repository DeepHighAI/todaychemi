  ...
  return (
    <div className="grid grid-cols-1 gap-3 px-4">
      <div data-card="avoid" className="bg-surface-2 rounded-[var(--r-lg)] p-4 space-y-1">
        ...
        <p className="text-base font-bold text-foreground">{card.avoid_phrase}</p>
        <p className="text-sm text-muted-foreground">{card.avoid_phrase_reason}</p>
      </div>
      <div data-card="favorable" className="bg-surface-2 rounded-[var(--r-lg)] p-4 space-y-1">
        ...
        <p className="text-base font-bold text-foreground">{card.favorable_action}</p>
        <p className="text-sm text-muted-foreground">{card.favorable_action_reason}</p>
      </div>
    </div>
  );
}
