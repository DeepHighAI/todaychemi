...
- situation_reading: 직장·협업 상황에서 드러나는 strength 3개 + caution 3개
- keywords: 정확히 5개
...
```json
{
  "body": "450-650자 본문. 오늘 날짜의 일운·월운·세운과 일간·오행·십신 derived를 연결해 직장·협업 환경에서 보이는 모습을 풍부하게 서술. 단정 금지, 가능성 표현.",
