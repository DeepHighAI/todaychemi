...
**Amended:** 2026-06-19 — **가격 인상 (§1.1 확정)**: 정가 케미카드·인연 등록 1,000 → **1,100원**, 만약에 우리 800 → **880원**, 케미 다시 맞추기 600 → **880원**. 오픈초기 50% 할인 현금가 **550 / 440 / 440 / 550원**, 무료 부적 10/8/6/10 → **11/9/9/11p** (부적도 비례, 1부적≈100원 유지; 880→9 반올림). 50% 할인 메커니즘·웹·미니앱 통일 유지
**Amended:** 2026-06-22 — **앱인토스 IAP 콘솔 확정가 반영 (§1.1 사용자 확정)**: `hapcard` 케미카드 판매가 550원(공급가 500원), `whatif` 또 다른 나 판매가 440원(공급가 400원), `replay` 케미 다시 맞추기 판매가 440원(공급가 400원), `relation_slot` 인연 슬롯 판매가 550원(공급가 500원). `feature-prices.ts`, 미니앱 표시가, 앱인토스 SKU 판매가, Vercel 서버 SKU 매핑을 동일하게 유지
...
유료 기능은 **케미카드(hapcard)·또 다른 나(whatif)·케미 다시 맞추기(replay)·인연 슬롯(relation_slot)** 4종이다. 이들을 사용
...
무료 부적 잔액이 충분하면 `token_ledger`에서 차감(케미카드 11p·또 다른 나 9p·케미 다시 맞추기 9p·인연 슬롯 11p).
잔액 부족 시 **1회성 현금 결제**(웹: Toss Payment Widget V2 / 앱인토스 미니앱: 인앱결제 IAP — 2026-06-07 D3)로 전환한다. 구독·번들 없음.

### 2. 가격 단일 출처
정가: 케미카드 1,100원 / 또 다른 나 880원 / 케미 다시 맞추기 880원 / 인연 슬롯(3번째+) 1,100원.
오픈초기 이벤트 현금가: 케미카드 550원 / 또 다른 나 440원 / 케미 다시 맞추기 440원 / 인연 슬롯(3번째+) 550원.
