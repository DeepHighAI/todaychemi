...
**확정 정책**: 디지털 상품(케미카드·또 다른 나·케미 다시 맞추기·인연 슬롯)은 **인앱결제(IAP)만**. 토스페이는 실물 전용. 토스페이먼츠 금지.

**IAP 플로우** (문서 + `with-in-app-purchase` 샘플로 확인):
1. 콘솔에 상품(SKU) 등록: 케미카드 550원(공급가 500원) / 또 다른 나 440원(공급가 400원) / 케미 다시 맞추기 440원(공급가 400원) / 인연 슬롯 550원(공급가 500원) — 4종 (판매가 = 공급가 + VAT)
...
| 4 | IAP 상품 4종 등록 | 케미카드 550원(공급가 500원) / 또 다른 나 440원(공급가 400원) / 케미 다시 맞추기 440원(공급가 400원) / 인연 슬롯 550원(공급가 500원), 상품명·아이콘·설명 | 콘솔에서 등록 |
...
6. **D6. 가격**: 2026-06-22 확정가 기준 케미카드/인연 슬롯 550원, 또 다른 나/케미 다시 맞추기 440원. 가격 변경은 ADR-039 + `feature-prices.ts` + 미니앱 표시가 + 앱인토스 SKU 문서 동시 갱신 의무.
...
| D6 | 가격 | 정가 **1,100 / 880 / 880 / 1,100원**, 현금가·IAP 판매가 **550 / 440 / 440 / 550원**(케미카드/또 다른 나/케미 다시 맞추기/인연 슬롯, 웹+미니앱 통일) |

D6 후속 의무(§12 변경 매트릭스): `feature-prices.ts`(단일출처)·ADR-039·`payments.md`·`fluttering-gathering-island.md`·`PRD.md`·미니앱 표시가·앱인토스 SKU 가격을 동시에 갱신한다. 2026-06-22 현행 확정가는 케미카드/인연 슬롯 550원, 또 다른 나/케미 다시 맞추기 440원이며, 부분 갱신 후 PR 금지.
...
| 또 다른 나 | GPT-5, in 2,500+out 600 | $10–15 / 1,000 | **₩13–20** |
...
| 또 다른 나 | 440 | ~352 | ~374 | ~293 | ~427 |
| 다시 맞추기 | 440 | ~352 | ~374 | ~293 | ~427 |
| 인연 슬롯 | 550 | ~440 | ~468 | ~366 | ~534 |

**LLM 차감 후 마진(미니앱 A):** 케미카드 ~₩419–427 / 또 다른 나 ~₩332–339 / 다시 ~₩331–337, 인연 슬롯은 LLM 생성비 없음. 판매가 대비 **대략 75–80%** → 마진 건전.
