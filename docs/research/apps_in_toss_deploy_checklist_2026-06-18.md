...
- [x] **B-4 IAP SKU 4종 등록** → SKU ID 수령 → A-6/A-7 기입.
  - 최종 확정가(2026-06-22): 케미카드 **₩550(공급가 500원)** · 오늘의 나는? **₩440(공급가 400원)** · 케미 다시 맞추기 **₩440(공급가 400원)** · 인연 슬롯 **₩550(공급가 500원)**.
...
- [ ] **E-2** 8 플로우 스모크: 온보딩·인연등록·케미피드·케미카드·오늘케미·본명식·오늘의 나는?·케미 다시 맞추기(+공유)
- [ ] **E-3** 토스 로그인 실세션(userKey → Supabase 매핑) 확인
- [ ] **E-4** IAP 실결제: 케미카드/오늘의 나는?/다시맞추기/인연슬롯 구매 → 잠금해제, 복원(getPendingOrders), 환불 폴링
