...
부동소수(0.3+0.5류) 비결정성 회피를 위해 정수만 사용(ADR-035). **비율(10:5:3)은 자체 단순화 —
RAG 검수(2026-06-12): 정기 우위 방향은 고전 사령 일수(18~23일/30일)와 정합하나, 사계월(辰戌丑未)
중기/여기 서열이 고전(여기7>중기5)과 역전 — 변경 권고 R1/R2 별도 컨펌 대기.**
...
> 산식 권고 R1/R2 별도 컨펌 대기). 크라우드 휴먼 검수는 §7.2 백로그 유지.
